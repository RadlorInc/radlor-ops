...
-- Test data only: this file is never applied to a real project.

insert into reviewers (id, name, email, token) values
...
update reviewers set revoked_at = now() where id = '22222222-2222-4222-8222-222222222222';

insert into videos (id, slug, title, storage_path, version, status, sort_order) values
...
insert into notes (video_id, reviewer_id, t_seconds, body, video_version, resolved_at) values
